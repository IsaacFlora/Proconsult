    ...
    <div class="wrapper-page">
        <div class="card">
            <div class="card-body">
                ...
                <div class="p-3">
                    <h4 class="text-muted font-18 m-b-5 text-center">Painel de suporte</h4>
                    ...
                    <form class="form-horizontal m-t-30" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group m-t-10 mb-0 row">
                            <div class="col-12 m-t-20 text-right">
                                <a href="{{ route('home') }}" class="text-muted"><i class="fa fa-user"></i> Não é cadastrado? Cadastre-se</a>
                            </div>
                        </div>
                    </form>
                </div>
