...
<div class="content-page">
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-6">
                    <form action="{{route('chamados.busca')}}" method="GET" class="row">
                        <div class="col-8">
                                ...
                                @if(count($chamados)>0)
    	                        	...
    	                        	<tr>
                                        ...
                                        <td>
                                            ...
                                            >
                                                <a href="{{route('chamados.listarchamados', $chamado->id)}}" class="btn btn-primary"><i class="fas fa-edit"></i> Visualizar</a>
