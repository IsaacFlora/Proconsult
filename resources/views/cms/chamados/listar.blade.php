	                    ...
	                    <div class="card-body">
                            ...
                            @if( $chamado->mensagens->count() )
                                ...
                                <div>
                                    ...
                                    <p><strong>{{$mensagem->remetente->name}}</strong> ( {{dataBr( Carbon\Carbon::parse( $mensagem->created_at ), true )}} )</p>
                                    <p>{{$mensagem->texto}}</p>
                            ...
                            @if( $chamado->status!=2 )
                            <form action="{{route('chamados.responder', $chamado->id)}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-check">
                                            <input value="1" name="finalizarchamado" type="checkbox" class="form-check-input" id="finalizarchamado1">
                                            <label class="form-check-label" for="exampleCheck1">Finalizar chamado</label>
                                        </div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12 text-right">
                                        ...
                                        <a href="{{route('chamados.index')}}" class="btn btn-danger btn-lg"><i class="fas fa-window-close"></i> Cancelar</a>
                                    </div>
                                </div>
                            </form>
                            @else
