...
use App\Http\Requests\UserscadastrarRequest;
...
class UsersController extends Controller
{
    ...
    public function cadastrar( UserscadastrarRequest $request ){
        ...
        $new['cpf']= $dados['cpf'];
        $new['password']= bcrypt( $dados['password'] );

        $usuarionovo= User::create($new);

        Auth::login($usuarionovo);
